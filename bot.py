...
# =============================================================================
# KEEP-ALIVE — не даём Render усыпить сервис
# Render бесплатный план усыпляет сервис после 15 минут без входящих запросов.
# Пингуем свой же /healthz каждые 10 минут — сервис остаётся живым 24/7.
# =============================================================================
